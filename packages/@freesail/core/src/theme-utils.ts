...
/** A plain map of CSS custom-property (or style) values, framework-agnostic. */
...
export const defaultLightTokens: FreesailThemeTokens = {
  ...
  textForeground: '#0d2233',
  textSecondary: '#4d8099',
  primary: '#77c4e6',
  primaryHover: '#4aaed9',
  primaryForeground: '#0d2233',
  error: '#ef4444',
  success: '#22c55e',
  warning: '#f59e0b',
  info: '#3b82f6',
...
export const defaultDarkTokens: FreesailThemeTokens = {
  ...
  textForeground: '#e8f4fa',
  textSecondary: '#7ab8d1',
  primary: '#77c4e6',
  primaryHover: '#55b5df',
...
export function tokensToCssVars(tokens: FreesailThemeTokens, mode: FreesailThemeMode = 'light'): CssVarMap {
  return {
...
export function surfaceThemeToCssVars(theme: FreesailSurfaceTheme): CssVarMap {
