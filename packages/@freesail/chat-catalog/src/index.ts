...
import { chatCatalogComponents } from './components/components.js';
import catalogSchema from './chat-catalog.json';

// Re-export all individual components for advanced usage
export * from './components/components.js';
export { chatCatalogComponents } from './components/components.js';
 ...
 * ```
 */
import { chatCatalogFunctions } from './functions/functions.js';
