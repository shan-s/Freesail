...
| `getDataModel` | Request the current data model from the frontend (Freesail specific extension)|
| `getComponentTree` | Request the current component tree from the frontend (Freesail specific extension) |
